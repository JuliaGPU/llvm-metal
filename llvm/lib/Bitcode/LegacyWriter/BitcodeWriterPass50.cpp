...
INITIALIZE_PASS_BEGIN(WriteBitcodePass50, "write-bitcode50", "Write 5.0 Bitcode", false,
                      true)
INITIALIZE_PASS_DEPENDENCY(ModuleSummaryIndexWrapperPass)
INITIALIZE_PASS_END(WriteBitcodePass50, "write-bitcode50", "Write 5.0 Bitcode", false,
                    true)
